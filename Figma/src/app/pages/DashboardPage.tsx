              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {isSuperuser && (
                      <Button variant="outline" size="sm" className="hidden sm:flex border-secondary/30 text-secondary hover:bg-secondary/5">
                        Gestionar
                      </Button>
                    )}
                  </div>
        ...
        <Card className="border-border shadow-sm">
          ...
          <CardContent className="pt-4">
            <div className="grid gap-3 sm:grid-cols-3">
              <Button variant="outline" className="justify-start h-auto py-4 px-4 border-border hover:border-primary/40 hover:bg-accent group">
